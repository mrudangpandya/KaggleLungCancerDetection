...
raw_image_path = '/run/media/harsh8398/Dell USB Portable HDD/LungCancerData/*/'
candidates_file = '/run/media/harsh8398/Dell USB Portable HDD/LungCancerCSV/candidates.csv'
